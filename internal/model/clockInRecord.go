...
type ClockInRecord struct {
	...
	Type      ClockInType `gorm:"column:type;type:tinyint unsigned;not null;comment:'1:clock in 2:clock out'"`
...
type ClockInType uint8

const (
	ClockInTypeUnkown ClockInType = iota
	ClockInTypeClockIn
	ClockInTypeClockOut
)
